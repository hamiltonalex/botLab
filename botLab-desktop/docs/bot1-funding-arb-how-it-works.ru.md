...
Всего семь вариантов. Сначала бот выбирает лучшее направление для BTC и для ETH по знаку ставок
за окно, затем сравнивает эти два варианта с тремя одноногими схемами и финансирует первый по
нетто.

...
- **Ворота те же, что у входа.** Отказ источника откладывает решение целиком, а не только ветку
  ...
  и на рынке сделки: если наблюдение прервалось надолго и покрытие упало ниже 684 часов, правило
  выхода не решает, пока дыра не выйдет из окна (до 30 суток), а сторож залога продолжает работать
  каждый тик.

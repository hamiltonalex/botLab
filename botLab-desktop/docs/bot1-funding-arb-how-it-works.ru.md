...
Активы сейчас только BTC и ETH. Для каждого доступны две парные схемы: A это шорт на GMX и лонг
на Hyperliquid, B это лонг на GMX и шорт на Hyperliquid. Плюс три одноногие схемы на GMX: ETH в
Arbitrum, BTC в Arbitrum и ETH в Avalanche. В них бот открывает шорт, а залог держит в той же
монете, без ноги на Hyperliquid.

Всего семь вариантов. Сначала бот выбирает направление A или B для BTC и для ETH по среднему
чистому спреду ставок за окно оценки: у какого направления средняя за 720 часов выше, то и берётся.
Затем оценивает размер и нетто этих двух вариантов и трёх одноногих схем на том же окне и
финансирует первый по нетто. Второе направление каждого парного рынка отдельную оптимизацию размера
не проходит.

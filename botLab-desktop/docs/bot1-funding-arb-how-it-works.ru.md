...
круг издержек, списанный при входе. Когда пик минус накопленное достигает двух кругов, сделка
...
flowchart LR
    ...
    C --> C1["круг по модели списан при входе;<br/>реальный выход дороже модели не виден"]

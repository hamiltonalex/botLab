...
| Расчёт входа | Последовательный обход семи схем с реальными обновлениями подбора размера, отказами и итоговым рейтингом; выбранный кандидат и открытая сделка различаются, исходный расчёт сохраняется вместе с позицией до закрытия |

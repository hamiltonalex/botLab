...
не дали ни одной прибыльной конфигурации. Закрыть сделку руками можно, но она навсегда
помечается как закрытая досрочно; сводка цепочки считает такие закрытия отдельным
счётчиком и предупреждает, что итог с ними выходит за пределы измеренного.

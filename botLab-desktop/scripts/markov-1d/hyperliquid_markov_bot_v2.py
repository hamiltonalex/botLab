...
FEE_ROUND_TRIP = 0.001  # комиссия за вход и выход вместе: 0,1% (на фьючерсах Binance по рынку 0,05% за вход и столько же за выход; на Hyperliquid базовый тейкер 0,045% на сторону, поставь 0.0009)

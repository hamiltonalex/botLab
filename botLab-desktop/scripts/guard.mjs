...
//
// КНИГ ПЯТЬ, И ПЕРВЫЕ ДВЕ ПРО ДРУГОГО БОТА. Две книги схемы продавца (эталон и живой движок бота 2)
// снимаются с пятилетней записи, три последние - с годовых фикстур репозитория и описывают бота 1.
// Своей сквозной сверки у бота 1 не было вовсе: его охрана состояла из аналитических golden-тестов,
// а слой, который и есть «результат бота», под охраной не стоял. Они дешёвые (секунды, записи не
// требуют), поэтому идут последними и ничего не удорожают.
//
// ПОЧЕМУ У БОТА 1 ТРИ КНИГИ, А НЕ ОДНА. Они стерегут ТРИ РАЗНЫХ СЛОЯ, и подменять один другим
...
const ALL_DROPS = [...new Set([...B2_DROPS, ...FA_DIL_DROPS, ...FA_SIZE_DROPS])];
...
console.log(`  три книги бота 1 по годовым фикстурам: секунды.`);

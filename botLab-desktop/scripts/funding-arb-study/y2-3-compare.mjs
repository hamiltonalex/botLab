...
//   6. ДАННЫЕ ПЕРИОДА НЕПОЛНЫ: 6 имён из 23 (AAVE, ATOM, AVAX, NEAR, OP, TAO) отдают
//      ставку тождественный ноль во ВСЕХ часах при медиане базы $102k-$718k и ненулевом
//      борроу в 98-100% часов. В кэше первого года у тех же имён ставка ненулевая в
//      100.0% часов, значит нули отдаёт индексатор, а не рынок.
//

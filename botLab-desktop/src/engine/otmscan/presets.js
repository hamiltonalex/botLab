...
export function defaultScanSettings() {
  return {
    // delta-v1, а не dmitri-v1: прогон 3 показал 0 сигналов за 72ч из-за теты и издержек дальних
    // страйков, и правка страйка к деньгам лечит ровно это. Существующие профили держат свой выбор
    // (presetId персистится), новый дефолт достаётся чистому профилю — то есть обкатке.
    presetId: "delta-v1",
    scanRepriceSec: 30,
    dwellTicks: 3,
    failTicks: 2,

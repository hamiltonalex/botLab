...
test("файл эталонов репозитория разбирается и описывает пять книг: две продавца и три бота 1", () => {
  ...
  // Книги ЛЕДЖЕРА снимает ОДИН скрипт в двух режимах, и одинаковая сумма означала бы, что режим
  ...
  // Книга ПРАВИЛА ВХОДА снимается третьим скриптом и стережёт другой слой: не начисление, а решение
